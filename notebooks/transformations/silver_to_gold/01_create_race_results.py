...
# final_df.write.mode("append").parquet(f"{gold_folder_path}/race_results")

# final_df.write.mode("append").parquet(f"{presentation_folder_path}/race_results")

# Creating Managed Tables
overwrite_partition(final_df, "f1_catalog", "f1_presentation", "race_results", "race_id")

#creating ext table
overwrite_partition_ext(final_df, "f1_catalog_ext", "f1_presentation_ext", "race_results", "race_id")

# final_df.write.mode("overwrite").format("delta").saveAsTable("f1_catalog.f1_presentation.race_results")
